	...
	if (!isOpen) {
		return (
			<button
				...
				className="fixed bottom-6 right-6 w-14 h-14 bg-black rounded-full flex items-center justify-center shadow-2xl hover:scale-105 transition-transform z-50"
				aria-label="打开客服聊天"
			>
				<svg
