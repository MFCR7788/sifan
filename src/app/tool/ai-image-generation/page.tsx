      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 sm:p-8 mb-6">
          ...
          <div className="flex items-start gap-4 mb-8">
            ...
            <div className="flex-1 bg-purple-50 rounded-2xl rounded-tl-none p-5">
          ...
          <div className="space-y-6">
            ...
            <ParamCard title="1. 主题内容（必填）">
              <textarea
                ...
                className="w-full min-h-[100px] px-4 py-3 rounded-xl border-2 border-gray-200 focus:outline-none focus:border-purple-500 transition-all duration-200 resize-none text-gray-900 placeholder-gray-400"
              />
            </ParamCard>
            ...
            <ParamCard title="3. 细节要求（选填）">
              <textarea
                ...
                className="w-full min-h-[80px] px-4 py-3 rounded-xl border-2 border-gray-200 focus:outline-none focus:border-purple-500 transition-all duration-200 resize-none text-gray-900 placeholder-gray-400"
              />
            </ParamCard>
            ...
            {isGenerating && (
              <div className="mb-4">
                <div className="flex items-center justify-between mb-1">
                  <span className="text-xs text-purple-600 font-medium">正在生成图像...</span>
                  <span className="text-xs text-purple-600">{Math.round(progress)}%</span>
                </div>
                  ...
                  <div className="absolute inset-0 bg-black/70 opacity-0 group-hover:opacity-100 transition-opacity flex flex-col justify-center items-center gap-3 p-4">
                    ...
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className="flex items-center gap-1 bg-purple-600 hover:bg-purple-700 text-white px-3 py-1.5 rounded text-xs transition-colors"
                      >
